...
public class SetWaterMeterFactorTokenGenerator extends Class2TokenGenerator {
    ...
    public List<SetWaterMeterFactorToken> generate() throws Exception {
        ...
        return Arrays.asList(facade.generateSetWaterMeterFactorToken(getRequestID(), iain, encryptionAlgorithm,
